<template>
      <div class="card bg-white">
            ...
            <div class="card-body" style="padding: 20px;">
                  ...
                  <table class="table mb-0 table-bordered table-hover" style="font-size: 16px;">
                                    ...
                                    <td class="text-center d-flex justify-content-center">
                                          <div class="d-flex order-actions justify-content-center">
                                                <button class="btn btn-warning" data-bs-toggle="modal"
                                                      data-bs-target="#ModalChinhsua" @click="moModal(value)">Sửa</button>
                                                <button class="btn btn-danger ms-3" data-bs-toggle="modal"
                                                      data-bs-target="#ModalXoa" @click="xoaThanhToan(value)">Xóa</button>
                                          </div>
                                    </td>
                              </tr>
                        </tbody>
...
export default {
      ...
      methods: {
            loadData() {
                  axios
                        .get("http://127.0.0.1:8000/api/admin/thanh-toan/data")
                        .then((res) => {
            ...
            themThanhToan() {
                  axios
                        .post("http://127.0.0.1:8000/api/admin/thanh-toan/create", this.them_tt)
                        .then((res) => {
                              if (res.data.status) {
                                    this.loadData();
                                    this.list_thanh_toan.push(this.them_tt);
            ...
            suaThanhToan() {
                  axios
                        .post("http://127.0.0.1:8000/api/admin/thanh-toan/update", this.sua_tt)
                        .then((res) => {
                              if (res.data.status) {
                                    this.loadData();
                                    alert(res.data.message);
            ...
            xoaThanhToan() {
                  axios
                        .post("http://127.0.0.1:8000/api/admin/thanh-toan/delete", this.xoa_tt)
                        .then((res) => {
                              if (res.data.status) {
                                    this.loadData();
                                    alert(res.data.message);
