                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <button class="btn btn- bg-success mt-3 text-light"
                                                style="width: 200px;">Hàng
                                                Đang Giao</button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-footer  bg-secondary text-light">
                                    Tổng Tiền: <span> 500.000</span> VND
                                </div>
                            </div>
                        </div>
                    </div>
